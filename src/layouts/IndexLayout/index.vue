...
export default defineComponent({
  ...
  data() {
    return {
      ...
      data: [
        ...
        // sysuser:"sysuser",
        // Khuser:'Khuser',
        // provincedistributor:'provincedistributor',
        // countrydistributor:'countrydistributor',
      },
  ...
  mounted() {
    ...
    let description = this.$store.state.user.currentUser.identities[0].role.description
    
    if(description == "全国经销商"){
      this.rolelv = {
        clerk: "clerk",
        shopowner: "shopowner", 
        citydistributor: "citydistributor",
    ...
    if(description == "店员"){
      this.rolelv.clerk = "clerk"
    }
    if(description == "店长"){
      this.rolelv.shopowner = "shopowner"
    }
    if(description == "市级经销商"){
      this.rolelv= {
        clerk: "clerk",
        shopowner: "shopowner", 
        citydistributor: "citydistributor",
    ...
    // console.log(this.$store.state.user.currentUser.identities[0].role.description);
