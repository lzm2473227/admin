      ...
      try {
        ...
        switch (rolename) {
          ...
          //门店管理员基础权限
            ...
            ,'public','file','noreceiveStatistics','nobank','bank','clerknoreceive','clerkreceive','clerkreceivenoreceive','clerkreceivenoreceiveStatistics','clerkreceivereceive','clerkreceiveStatistics'
            ]
            ...
            rolelv.forEach((item)=>{
              if(item=="clerk"){
                //店员身份权限
                userDetails.roles.push('clerk','clerknoreceive','clerkreceive','clerknocheckproduct','clerknosale','clerksales','clerkcheckproduct','clerkbank','clerkguarantee','clerkreceivenoreceive','clerkreceivenoreceiveStatistics','clerkreceivereceive','clerkreceiveStatistics');
              }
              if(item=="shopowner"){
                //店长身份权限
