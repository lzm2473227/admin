<template>
  <div class="productup">
    ...
    <div class="product-btnup">
      <el-button type="primary" size="other" @click="ProducUp">上架</el-button>
    </div>
    <div class="product-list">
      ...
      >
        ...
        <el-table-column label="上架数量" prop="stock"> </el-table-column>
      </el-table>
  ...
  methods: {
    ...
    ProducUp() {
      ...
      if (t.multipleSelection.length < 1) {
        t.$message({ message: "请选择要上架的商品", type: "error" });
      } else {
        t.$message({
          message: "商品已上架",
          type: "success",
