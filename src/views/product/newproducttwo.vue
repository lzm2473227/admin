<template>
  <form ref="form" @submit.prevent="addcomm()">
    <div class="tab">
      <div class="tab-title">
        <div class="left">
      ...
      <div class="table-main">
        <table border="1" class="">
          ...
          <tr>
            <td class="table-left">商品图片</td>
            <td class="table-right" colspan="3" style="height: 320px"></td>
            <el-upload
...
export default {
  ...
  methods: {
    ...
    addcomm() {
      ...
      let url = this.$route.query.commodityCode
