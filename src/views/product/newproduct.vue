      ...
      <div class="table-main">
        ...
        <table border="1" class="">
          <tr>
            ...
            <td class="table-right">
              <input type="text" v-model="form.barcode" placeholder="请输入商品69编码" :disabled="isDisable"/>
            </td>
          </tr>
          <tr>
...
export default {
  ...
  methods: {
    ...
    handleChange(){
      ...
      this.form.rank = obj[0].data.rank
    },
    getdata() {
      let t = this;
    ...
    addcomm() {
      ...
      let params = {
        ...
        categoryId:this.form.categoryId,   //三级目录id
        rank:this.form.rank,              //三级目录标识
      };
      ...
      // console.log(this.categoriesCatalog);
        // console.log(id);
      if(this.form.rank!=3) return this.$message.error("请选择已有的三级分类，或者添加三级分类")
      if(this.form.rank=3){
