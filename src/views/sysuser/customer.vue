  ...
  <div class="tab">
    ...
    <div class="tab-body">
      ...
      >
        ...
        <el-table-column prop="manufacturer" label="商品单价" sortable width="120"></el-table-column>
        <el-table-column prop="manufacturer" label="交易时间" sortable width="140"></el-table-column>
        <el-table-column prop="manufacturer" label="消费者" sortable width="120"></el-table-column>
        <el-table-column prop="manufacturer" label="消费者电话" sortable width="160"></el-table-column>
        <el-table-column prop="manufacturer" label="付款方式" sortable width="140"></el-table-column>
        <el-table-column prop="time" label="付款账户号码" align="center"  sortable width="140" ></el-table-column>
      </el-table>
    </div>
    <div class="bot">
