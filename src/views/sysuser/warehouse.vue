  ...
  <div class="tab">
    ...
    <div class="tab-body">
      ...
      >
        ...
        <el-table-column prop="manufacturer" label="入库操作人" sortable width="120"></el-table-column>
        <el-table-column prop="manufacturer" label="入库时间" sortable width="140"></el-table-column>
        <el-table-column prop="manufacturer" label="盘库操作人" sortable width="120"></el-table-column>
        <el-table-column prop="manufacturer" label="盘库时间" sortable width="160"></el-table-column>
        <el-table-column prop="manufacturer" label="出库操作人" sortable width="140"></el-table-column>
        <el-table-column prop="time" label="出库时间" align="center"  sortable width="140" ></el-table-column>
      </el-table>
    </div>
    <div class="bot">
