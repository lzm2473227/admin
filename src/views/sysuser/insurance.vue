  ...
  <div class="tab">
    ...
    <div class="tab-body">
      ...
      >
        ...
        <el-table-column prop="manufacturer" label="保险机构" sortable width="120"></el-table-column>
        <el-table-column prop="manufacturer" label="保险内容" sortable width="140"></el-table-column>
        <el-table-column prop="manufacturer" label="保险范围" sortable width="120"></el-table-column>
        <el-table-column prop="manufacturer" label="保险期限" sortable width="160"></el-table-column>
        <el-table-column prop="manufacturer" label="保险单价" sortable width="140"></el-table-column>
        <el-table-column prop="time" label="保险单号" align="center"  sortable width="140" ></el-table-column>
      </el-table>
    </div>
    <div class="bot">
