  ...
  <div class="tab">
    ...
    <div class="tab-body">
      ...
      >
        ...
        <el-table-column prop="manufacturer" label="物流配送公司" sortable width="140"></el-table-column>
        <el-table-column prop="manufacturer" label="配送接收人" sortable width="140"></el-table-column>
        <el-table-column prop="manufacturer" label="配送接收时间" sortable width="140"></el-table-column>
        <el-table-column prop="manufacturer" label="消费者电话" sortable width="160"></el-table-column>
        <el-table-column prop="manufacturer" label="配送送达人" sortable width="140"></el-table-column>
        <el-table-column prop="time" label="配送送达时间" align="center"  sortable width="140" ></el-table-column>
      </el-table>
    </div>
    <div class="bot">
