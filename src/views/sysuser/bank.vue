  ...
  <div class="tab">
    ...
    <div class="tab-body">
      ...
      >
        ...
        <el-table-column prop="manufacturer" show-overflow-tooltip label="品牌" sortable width="100"></el-table-column>
        <el-table-column prop="manufacturer" label="银行机构" sortable width="120"></el-table-column>
        <el-table-column prop="manufacturer" label="付款单价" sortable width="140"></el-table-column>
        <el-table-column prop="manufacturer" label="付款单号" sortable width="120"></el-table-column>
      </el-table>
    </div>
    <div class="bot">
