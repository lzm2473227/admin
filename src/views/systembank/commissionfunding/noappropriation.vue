<template>
  <div class="tab">
    <div class="tab-title">
      <div class="left">
        <div class="print" @click="confirm"><img class="icon" src="@/assets/images/confirm.png" alt=""><span class="axis">拨款指令</span></div>
    ...
    <div class="tab-body">
      ...
      >
        ...
        <el-table-column prop="barcode" label="店员姓名" align="center" sortable width="240"></el-table-column>
        <el-table-column prop="barcode" label="店员手机号" align="center" sortable width="240"></el-table-column>
        ...
        <el-table-column prop="manufacturer" label="开户银行" sortable width="180"></el-table-column>
        ...
        <el-table-column prop="commodityName" label="开户时间" sortable width="140"></el-table-column>
        <el-table-column prop="brandName" label="开户佣金" sortable width="140"></el-table-column>
        <el-table-column prop="manufacturer" label="可提现佣金" sortable width="140"></el-table-column>
