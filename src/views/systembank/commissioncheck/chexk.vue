  ...
  <div class="tab">
    ...
    <div class="tab-body">
      ...
      >
        ...
        <el-table-column prop="manufacturer" label="开户佣金（店员）" sortable width="150"></el-table-column>
        <el-table-column prop="manufacturer" label="可提现佣金" sortable width="180"></el-table-column>
        <el-table-column prop="manufacturer" label="佣金状态" sortable width="180"></el-table-column>
