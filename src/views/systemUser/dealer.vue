  ...
  <div class="tab">
    ...
    <div class="storelist">
      ...
      >
        ...
        <el-table-column prop="orgCode" align="center" label="机构代码" width="200" sortable>
        </el-table-column>
        <el-table-column prop="enterpriseName" align="center" label="单位名称" sortable width="150">
        </el-table-column>
        <el-table-column prop="city" align="center" label="单位地址" sortable width="350">
        </el-table-column>
        <el-table-column prop="legalPerson" align="center" label="法人代表" sortable width="100">
        </el-table-column>
        <el-table-column prop="legalPerson" align="center" label="代理人" sortable width="100">
        </el-table-column>
        <el-table-column prop="idNumber" align="center" label="代理人身份证号" sortable width="250">
        </el-table-column>
        <el-table-column prop="userMobile" align="center" label="代理人手机号" sortable width="150">
        </el-table-column>
      </el-table>
      <div class="bot">
