<template>
  <div class="tab">
    <div class="tab-title">
      <div class="left">
        <div class="print" @click="$router.push('/systemUser/newuser')"><img class="icon" src="@/assets/images/add.png" alt=""><span class="axis">新增单位</span></div>
    ...
    <div class="tab-body">
      ...
      >
        ...
        <el-table-column prop="specsParameter" label="系统用户类别" sortable width="200"></el-table-column>
        ...
        <el-table-column prop="price" label="代理人身份证" sortable width="220">
