<template>
  <div class="tab">
    <div class="tab-title">
      <div class="left">
        <div class="print"><img src="../../assets/images/ic-打印列表.png" alt="">打印列表</div>
        <div class="border"></div>
        <div class="derive" @click="exportExcel"><img src="../../assets/images/ic-导出表格.png" alt="">导出表格</div>
      </div>
      <div class="right">
        ...
        <!-- <el-button @click="setCurrent(tableData[1])">按商品69编码统计</el-button>
        <el-button @click="setCurrent(tableData[0])">按单品编码统计</el-button> -->
        <div class="setup">
