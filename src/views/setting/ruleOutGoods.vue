  ...
  <div class="ruleoutgoods">
    ...
    <div class="tab-body">
      ...
      >
        ...
        <el-table-column label="商品69编码" align="center" sortable ></el-table-column>
        <el-table-column label="商品名称" align="center" sortable ></el-table-column>
        <el-table-column label="商品规格" align="center" sortable ></el-table-column>
        <el-table-column label="商品品牌" align="center" sortable ></el-table-column>
        <el-table-column label="生产厂商" align="center" sortable ></el-table-column>
        <el-table-column label="商品三级分类" align="center" sortable ></el-table-column>
        <el-table-column label="商品单价" align="center" sortable ></el-table-column>
      </el-table>
    </div>
    <div class="bot">
    ...
    <div class="inp-bot">
      <el-form :inline="true" :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="input-with-select">
        <el-form-item label="商品名称:" prop="name" class="name-search" style="margin-left:16px">
