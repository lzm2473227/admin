  ...
  <div class="tab">
    ...
    <div class="tab-body">
      ...
      >
        ...
        <el-table-column prop="time" label="收货数量" align="center" sortable width="140" ></el-table-column>
        <el-table-column prop="time" label="收货时间" align="center" sortable width="160" ></el-table-column>
        <el-table-column label="" align="center" width="315" ></el-table-column>
      </el-table>
    </div>
    <div class="bot">
    ...
    <div class="total">
      <div class="statistic-item1">待收货商品种类：<span>{{totalNum}}</span></div>
      <div class="statistic-item2">待收货商品数量：<span>{{totalNum}}</span></div>
