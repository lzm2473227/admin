  ...
  <div class="tab">
    ...
    <div class="tab-body">
      ...
      >
        ...
        <el-table-column prop="time" label="售出时间" align="center"  sortable width="193" ></el-table-column>
        <el-table-column prop="people" label="销售员" align="center"  sortable width="193" ></el-table-column>
      </el-table>
    </div>
    <div class="bot">
