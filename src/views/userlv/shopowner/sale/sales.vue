  ...
  <div class="tab">
    ...
    <div class="tab-body">
      ...
      >
        ...
        <el-table-column prop="commodityName" label="商品名称" sortable width="190" show-overflow-tooltip></el-table-column>
        <el-table-column prop="specsParameter" label="商品规格" sortable width="130" show-overflow-tooltip></el-table-column>
        ...
        <el-table-column label="促销价（元）" align="right" sortable width="130">
          <template v-slot="scope">
        ...
        <el-table-column prop="time" label="订单类型" align="center"  sortable width="110" ></el-table-column>
