  ...
  <div class="tab">
    ...
    <div class="tab-body">
      ...
      >
        ...
        <el-table-column prop="commodityName" label="商品名称" sortable width="400" show-overflow-tooltip></el-table-column>
        <el-table-column prop="specsParameter" label="商品规格" sortable width="250" show-overflow-tooltip></el-table-column>
        <el-table-column prop="brandName" label="品牌" sortable width="160" show-overflow-tooltip></el-table-column>
        <el-table-column prop="price" label="单价（元）" sortable width="120" align="right">
          <template v-slot="scope">
						{{ scope.row.price }}
					</template>
        </el-table-column>
        <el-table-column prop="price" label="促销价（元）" sortable width="120" align="right">
          <template v-slot="scope">
						<span class="table-price">{{ scope.row.price }}</span>
					</template>
        </el-table-column>
        <el-table-column prop="brandName" label="小活动名称" sortable width="203" show-overflow-tooltip></el-table-column>
      </el-table>
    </div>
    <div class="bot">
