<template>
  <div class="tab">
    ...
    <div class="total">
      <div class="statistic-item1">已推送保单单品编码数量：<span>{{totalNum}}</span></div>
      <div class="statistic-item2">已推送保单商品种类：<span>{{totalNum}}</span></div>
      <div class="statistic-item3">已推送保单号数量：<span class="small">￥</span><span>0</span></div>
    </div>
    <div class="inp-bot">
