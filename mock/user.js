  ...
  if (headers[ajaxHeadersTokenKey] === 'admin') {
    res.send({
      ...
      data: {
        ...
        name: '门店',
        avatar: '',
        roles: ['md', 'productlist', 'purchase', 'product', 'inventory', 'sale', 'setting', 'user', 'noreceive', 'receive', 'checkproduct', 'nocheckproduct', 'sales', 'nosale', 'storelist', 'machine',
          'role', 'power', 'newstore', 'clerklist', "newproduct",'newclerk','advertmentlist','newadvertment','Authority'
        ],
      },
    });
    ...
    res.send({
      ...
      data: {
        ...
        name: '凯华管理员',
        avatar: '',
        roles: ['kh','product','productinfo','store','storeapproval'],
      },
    });
